...
public class MakeIdUtil {
    ...
    public MakeIdUtil(long workerId, long datacenterId, long sequence) {
        ...
        if (datacenterId > maxDatacenterId || datacenterId < 0) {
            throw new IllegalArgumentException(String.format("datacenter Id " +
                            "can't be greater than %d or less than 0",
                    maxDatacenterId));
        }
        System.out.printf("worker starting. timestamp left shift %d, " +
                        "datacenter id bits %d, worker id bits %d, sequence " +
                        "bits %d, workerid %d",
